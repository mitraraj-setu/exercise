...
#
#     final_dictionary = {}
#     warehouse_temp = i['warehouse']
#
#     warehouse_temp_list.append(warehouse_temp)
#     warehouse_temp_set = {x for x in warehouse_temp_list}
#     warehouse_temp_list = list(warehouse_temp_set)
#
# print(warehouse_temp_list)
# product_list = []
