...
for i in mylist:
    ...
    if (index % 2 == 0):
        revised_quantity = (i.get('quantity')) * 100
        i.update({'quantity': revised_quantity, 'warehouse':'even_san_francisco'})

    else:
        revised_quantity = (i.get('quantity')) - 100
        i.update({'quantity': revised_quantity, 'warehouse':'odd_san_francisco'})
