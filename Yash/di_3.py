...
for list in my:
    ...
    warehouse = warehouse.replace(" ", "_")
    qty = list.get("quantity")
    if index % 2 == 0:
        warehouse = "even" + "_" + warehouse
        V.append({'product': list["product"], 'quantity': qty * 100, 'warehouse': warehouse})
    else:
        warehouse = "odd" + "_" + warehouse
        V.append({'product': list["product"], 'quantity': qty - 100, 'warehouse': warehouse})
print(V)
